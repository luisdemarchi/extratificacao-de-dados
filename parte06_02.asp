<%'application("PlanAtiva") = "plan20090825210445"
...
totalDeCampos = int(protecao(request.form("perguntas")))

For i = 1 To (totalDeCampos)
	id = protecao(request.form("idPerg"&i))
	nome = protecao(request.form("pergunta"&i))
	
	mysql.execute "INSERT INTO perguntas (ligacaoID,pergunta) VALUES ("&id&",'"&nome&"')"
Next

mysql.close
response.redirect("parte07_inicio.asp")%>
